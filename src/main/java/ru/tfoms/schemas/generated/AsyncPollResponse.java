...
@XmlSeeAlso({
    ChangeAllPoliciesInsuranceToTfomsPollResponse.class,
    GetViewDataInsurancePollResponse.class,
    GetViewDataAttachPollResponse.class,
    GetInsuranceStatusChangesPollResponse.class,
    GetAllCurrentEnpPollResponse.class
})
