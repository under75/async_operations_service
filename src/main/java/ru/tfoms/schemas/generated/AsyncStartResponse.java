...
@XmlSeeAlso({
    ChangeAllPoliciesInsuranceToTfomsStartResponse.class,
    GetViewDataInsuranceStartResponse.class,
    GetViewDataAttachStartResponse.class,
    GetInsuranceStatusChangesStartResponse.class,
    AsyncPollResponse.class,
    GetAllCurrentEnpStartResponse.class
})
