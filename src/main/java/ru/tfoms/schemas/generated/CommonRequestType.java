...
@XmlSeeAlso({
    ChangeAllPoliciesInsuranceToTfomsStartRequest.class,
    GetViewDataInsuranceStartRequest.class,
    GetViewDataAttachStartRequest.class,
    GetInsuranceStatusChangesStartRequest.class,
    AsyncPollRequest.class,
    GetAllCurrentEnpStartRequest.class
})
